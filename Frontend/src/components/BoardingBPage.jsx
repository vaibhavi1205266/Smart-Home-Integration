    ...
    return (
        <>
            ...
            <div className="flex mt-2 ml-4 space-x-2 sm:mb-0 sm:absolute sm:bottom-10 sm:left-8">
                ...
                <button onClick={()=> navigate('/boarding3')} className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl mr-3 md:mr-4 rounded-3xl bg-sky-400 px-6 py-1 md:px-14 md:py-2 font-semibold mb-4 sm:mb-0 sm:absolute sm:bottom-8 sm:right-16">
                    Next
                </button>
            </div>
        </>
