    ...
    return (
        <>
            ...
            <div className="flex mt-6 ml-4 space-x-2 sm:mb-0 sm:absolute sm:bottom-10 sm:left-8">
                ...
                <button onClick={()=> navigate('/boarding3')} className="text-2xl mr-10 rounded-3xl bg-sky-400 px-14 py-2 font-semibold mb-4 sm:mb-0 sm:absolute sm:bottom-8 sm:right-16">
                    Next
                </button>
            </div>
        </>
