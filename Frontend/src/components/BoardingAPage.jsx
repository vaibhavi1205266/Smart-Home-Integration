...
const BoardingAPage = () => {
    ...
    return (
        <>
            ...
            <div>
                <button onClick={() => navigate('/boarding2')} className="text-2xl absolute bottom-8 rounded-3xl right-16 bg-sky-400 px-14 py-2 font-semibold">
                    Next
                </button>
                <div className="flex absolute bottom-10 left-8 space-x-2">
                    <button onClick={() => navigate('/boarding1')} className="w-12 h-3 rounded-full bg-sky-400"></button>
